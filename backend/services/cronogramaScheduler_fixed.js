        ...
        const query = `
            SELECT 
                ...
                CASE 
                    ...
                    WHEN c.fecha_maxima_facturacion IS NOT NULL AND DATEDIFF(c.fecha_maxima_facturacion, CURDATE()) = 0 THEN 
            ...
            WHERE c.activo = TRUE
                AND (
                    ...
                    OR (c.fecha_maxima_facturacion IS NOT NULL AND DATEDIFF(c.fecha_maxima_facturacion, CURDATE()) = 0)
                )
        `;
