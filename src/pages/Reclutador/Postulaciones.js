    ...
    <div className="postulaciones-container">
      <div className="header-section">
        <div className="titulo-seccion">
          ...
          <p>Administra las postulaciones de candidatos a las vacantes</p>
        </div>
      </div>
        ...
        {filtrarPostulaciones().map(postulacion => (
          <div key={postulacion.id} className="postulacion-card">
            <div className="postulacion-header">
              ...
              <span className={`estado ${postulacion.estado.toLowerCase().replace(' ', '-')}`}>
                {postulacion.estado}
              </span>
            </div>
            ...
            <div className="postulacion-info">
              ...
              <div className="info-item">
                ...
                <span>Evaluación: {postulacion.evaluacion}/5</span>
              </div>
            </div>
